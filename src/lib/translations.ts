...
export const translations = {
  en: {
    ...
    auth: {
        loginTitle: "Enter your username",
        loginDescription: "Enter your username to log in or create a new account.",
  ...
  ar: {
    ...
    auth: {
      loginTitle: "أدخل اسم المستخدم الخاص بك",
      loginDescription: "أدخل اسم المستخدم لتسجيل الدخول أو لإنشاء حساب جديد.",
